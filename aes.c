...
uint8_t mult(uint8_t a, uint8_t b){
	 ...
	 * mult_table02 represents the multiplication by 0X02
	 * mult_table03 represents the multiplication by 0X03
	 * In the mix_column transformation, only multiplication by 0X02 and 0X03 is performed.*/
	static const mult_table02={
